...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/hertleac'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/hertleac-creator/225-lab3-1.git'                   // <------change this
        KUBECONFIG = credentials('hertleac-225')                                             // <------change this
    }
